...
function color_filler(current_year, current_year_freq){
    ...
    } else if (typeof b !== 'undefined' && typeof g !== 'undefined'){
        //iterates through all words, distributes % of red/blue/green
        for (var word in b){
            //this format is used to 'fill' svg objects
    ...
    function draw(words) {
        ...
        cloud.transition()
            ...
            .style("fill", function(d, i){ 
                ...
                else if (global_instance == 2){return timeslot_word_color[global_instance][d.text];}
                else {return timeslot_word_color[global_instance][d.text];}
            })
